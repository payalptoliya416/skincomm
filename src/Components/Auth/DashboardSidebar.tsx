...
const DashboardSidebar = ({ loginState }: any) => {
    ...
    const handleLogout = async () => {
        ...
        sessionStorage.removeItem('dashboardAddmemberCredit');
  ...
  <>
    <div className="text-black">
      ...
      <h4 className="text-sm sm:text-3xl font-semibold mt-1 text-white">
        USD {(+balanceData.available_pp || 0).toFixed(2)}
      </h4>
    </div>
    ...
    <div className="text-black">
      ...
      <h4 className="text-sm sm:text-3xl font-semibold mt-1 text-white">
        USD {(+balanceData.available_lp || 0).toFixed(2)}
      </h4>
    </div>
    ...
    <div className="text-black">
      ...
      <h4 className="text-sm sm:text-3xl font-semibold mt-1 text-white">
        USD {(+balanceData.available_pp2 || 0).toFixed(2)}
      </h4>
    </div>
    ...
    <div className="text-black">
      ...
      <h4 className="text-sm sm:text-3xl font-semibold mt-1 text-white">
        USD {(+balanceData.available_sp || 0).toFixed(2)}
      </h4>
    </div>
  </>
)}
