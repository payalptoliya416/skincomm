                    ...
                    <div className="">
                        <ul className="flex items-center justify-around">
                            ...
                            <li className="">
                                <Link
                                    to={ '/settings' }
                                    className={ classNames('text-center inline-block py-2', { 'text-main-color border-t-2 border-main-color': location.pathname === '/settings' || location.pathname === '/profile' || location.pathname === '/primary_password' || location.pathname === '/security_password' || location.pathname === '/share'|| location.pathname === '/addbankpage' || location.pathname === '/addbankform' ||location.pathname === '/withdrawal', 'text-custom-text-color': location.pathname !== '/settings' && location.pathname !== '/profile' && location.pathname !== '/primary_password' && location.pathname !== '/security_password' && location.pathname !== '/share' && location.pathname !== '/addbankpage' && location.pathname === '/addbankform' }) }
                                >
                                    <svg
                                        className="w-6 h-6 m-auto"
                                        aria-hidden="true"
