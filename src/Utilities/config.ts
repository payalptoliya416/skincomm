...
// const BASE_URL: string = ENV === 'development' ?  'http://127.0.0.1:8000' : 'http://192.168.1.11:8005';
...
const E_LIBRARY_LIST : string = BASE_URL + '/api/e-library-ajax'    
const E_LIBRARY_SHOW_CATEGORY : string = BASE_URL + '/api/e-library-ajax'    
const E_LIBRARY_GET_SUB_CATEGORY : string = BASE_URL + '/api/e-library-get-sub-category'    
const E_LIBRARY_POST : string = BASE_URL + '/api/e-library-post'    
