        ...
        <div className="bg-white px-12 py-10  md:mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="flex gap-5 text-start ">
              <ul>
                <li className="text-sm xl:text-base font-semibold leading-[18px] mb-1">
                  Date :
                </li>
                <li className="text-sm xl:text-base font-semibold leading-[18px] mb-1">
                  Invoice Id :
              ...
              <ul>
                {memberDetail && (
                  <>
                    ...
                    <li className="text-sm xl:text-base font-normal leading-[18px] mb-[5px]">
                      {memberDetail.invoice_id}
                    </li>
                    <li className="text-sm xl:text-base font-normal leading-[18px] mb-[5px]">
                      {memberDetail.associate_id}
                    </li>
                    <li className="text-sm xl:text-base font-normal leading-[18px] mb-[5px]">
