...
function Announcement() {
  ...
  <p className="text-red-500">{AnnouncementData?.message}</p>
) : AnnouncementData?.announcements?.length > 0 ? (
  AnnouncementData.announcements.map((item: Announdata, index: number) => (
...
second: '2-digit',
  ...
  <svg
    aria-hidden="true"
    className="w-8 h-8 text-black animate-spin dark:text-black fill-blue-600"
    viewBox="0 0 100 101"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  >
